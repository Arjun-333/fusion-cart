    ...
    <div className="flex min-h-screen bg-[var(--beige-bg)] text-[var(--dark-brown)] font-sans">
      ...
      <main className="flex-1 p-8 overflow-auto">
        ...
        <header className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold">Toys Collection</h1>
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-[var(--shop-card-bg)] text-[var(--beige-bg)] p-4 rounded-lg shadow-md">
              ...
              <p className="text-[var(--light-brown)] mb-4">$29</p>
              <a
            ...
            <div className="bg-[var(--shop-card-bg)] text-[var(--beige-bg)] p-4 rounded-lg shadow-md">
              <img
                ...
                className="rounded-lg mb-4"
              />
              <h3 className="text-lg font-semibold mb-2">Remote Control Car</h3>
            ...
            <div className="bg-[var(--shop-card-bg)] text-[var(--beige-bg)] p-4 rounded-lg shadow-md">
              <img
                ...
                className="rounded-lg mb-4"
              />
              <h3 className="text-lg font-semibold mb-2">Stuffed Animal</h3>
              <p className="text-[var(--light-brown)] mb-4">$19</p>
              <a
                href="https://www.flipkart.com"
                target="_blank"
                rel="noopener noreferrer"
